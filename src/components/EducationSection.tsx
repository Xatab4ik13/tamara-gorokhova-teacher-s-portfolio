...
const EducationSection = () => {
  const education = [
    ...
    },
    {
      ...
      title: "Музыка",
      institution: "ООО «Инфоурок»",
      description: "Профессиональная переподготовка по программе «Музыка: теория и методика преподавания в сфере дошкольного образования». Квалификация: Воспитатель (Музыкальный руководитель)",
      icon: Award,
    },
  ];
